    ...
    if (printWindow) {
      printWindow.document.write(`
        <html>
          ...
          <body>
            <div class="header">
              <h1>🤰 NeoMama Labor Monitor Report</h1>
              <div class="info-row">
            ...
            <div class="footer">
              <p><strong>NeoMama</strong> - Supporting Kenyan mothers through every step</p>
...
Generated by NeoMama - Labor Monitor`;
  };

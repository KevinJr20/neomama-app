...
export const featureCardsData: FeatureCardData[] = [
  ...
  },
  {
    ...
    description: 'Track symptoms & get guidance',
    comingSoon: false
  },
  {
    id: 'mental-health',
  ...
  },
  {
    ...
    bgColor: 'bg-purple-100 dark:bg-purple-950/30',
    iconColor: 'text-purple-600 dark:text-purple-400',
    description: 'Smart pregnancy guidance 24/7',
    comingSoon: false
  },
  {
    id: 'buddy-system',
  ...
  },
  {
    ...
    bgColor: 'bg-red-100 dark:bg-red-950/30',
    iconColor: 'text-red-600 dark:text-red-400',
    description: 'Emergency protocols & hotlines',
    comingSoon: false
  },
  {
    id: 'complications',
  ...
  },
  {
    ...
    description: 'Community Health Worker mode',
    comingSoon: false
  }
];
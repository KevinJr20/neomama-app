...
interface UbuntuSisterhoodNetworkProps {
  onBack: () => void;
  userName?: string;
}
...
export function UbuntuSisterhoodNetwork({ onBack, userName = "Brenda" }: UbuntuSisterhoodNetworkProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 bg-white">
        ...
        <h1 className="text-lg text-foreground">Ubuntu Sisterhood</h1>
          ...
          <Card className="bg-gradient-to-r from-primary/10 via-purple/10 to-pink/10 border-primary/20">
            <CardContent className="p-4 text-center">
              <div className="flex items-center justify-center space-x-2 mb-2">
                ...
                <h3 className="text-foreground">Ubuntu: "I am because we are"</h3>
              </div>

  ...
  const supportSections = [
    {
      ...
      action: () => {
        window.open('mailto:support@neomama.ke?subject=NeoMama Support Request', '_blank');
      }
    },
    {
      icon: Shield,
      ...
      action: () => {
        window.open('https://neomama.ke/privacy', '_blank');
      }
    },
    {
      icon: Info,
      ...
      action: () => {
        window.open('https://neomama.ke/terms', '_blank');
      }
    },
    {
      icon: Heart,
    ...
    },
    {
      ...
      description: 'Share NeoMama with other mothers',
      action: async () => {
    ...
    },
    {
      ...
      action: () => {
        window.open('mailto:feedback@neomama.ke?subject=NeoMama Feedback&body=Hi NeoMama Team,%0D%0A%0D%0AI would like to share the following feedback:%0D%0A%0D%0A', '_blank');
      }
    }
  ];
  ...
  return (
    ...
    >
      ...
      <div className="pb-20">
          ...
          <div className="space-y-3">
            ...
            <Card 
              ...
              onClick={() => {
                ...
                a.href = url;
                a.download = `neomama-data-${new Date().toISOString().split('T')[0]}.json`;
                a.click();
        ...
        <div className="p-4 border-b border-border">
          <div className="mb-3">
            <h3 className="text-foreground">About NeoMama</h3>
          </div>
          ...
          <div className="space-y-3">
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-2 border-t border-border">
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      NeoMama is built with love for African mothers, celebrating Ubuntu philosophy 
            ...
            <div className="grid grid-cols-2 gap-3">
              <Card 
                className="border-border cursor-pointer hover:shadow-sm transition-shadow hover:border-primary/50"
                onClick={() => window.open('https://neomama.ke/privacy', '_blank')}
              >
              ...
              <Card 
                className="border-border cursor-pointer hover:shadow-sm transition-shadow hover:border-primary/50"
                onClick={() => window.open('https://neomama.ke/terms', '_blank')}
              >
                <CardContent className="p-4 text-center">
                  <ExternalLink className="w-5 h-5 text-primary mx-auto mb-2" />
            ...
            >
              <CardContent className="p-4 text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">neomama.ke</p>
              </CardContent>
            </Card>
          </div>
        </div>
